...
- those who have a marker value above c
at time t /those who have died by t is the denominator - those who a threshold, c, among these are considered true positives

Dynamic Specificity
- Those who are alive at time t / those who ahve a marker value less than or equal to c (true negatives)
