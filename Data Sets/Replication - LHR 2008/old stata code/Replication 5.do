...
poisson _d capchange battletide thirdpartycfire index onedem5 twodem5 twodem5lnt tie lndeaths cfhist stakes contiguity contiguitylnt ibn.interval, cluster(LHRcluster)
outreg2 using results_posterV3_cox
estat ic
...
zipcv _d capchange battletide thirdpartycfire index onedem5 twodem5 twodem5lnt tie lndeaths cfhist stakes contiguity contiguitylnt ibn.interval, inflate(archigosFIRC capchange battletide thirdpartycfire index onedem5 twodem5 tie lndeaths cfhist stakes contiguity) cluster(LHRcluster)
outreg2 using results_posterV3_zip
estat ic
*5524   -278.5088   -233.1439     32     530.2878    742.0273
*Vuong Test
zipcv _d capchange battletide thirdpartycfire index onedem5 tie lndeaths cfhist stakes contiguity contiguitylnt ibn.interval, inflate(capchange battletide thirdpartycfire index onedem5 tie lndeaths cfhist stakes contiguity) vce(cluster LHRcluster)
