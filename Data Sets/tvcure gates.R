...
gates <- read.dta13("C:/Users/gwill/Dropbox/Research/Dissertation/tvcure/Data Sets/AOWYDataGates2016Replication.dta")
...
gates.coxphf <- coxphf(Surv(start, stop, event) ~ dispersive * lnpop, data = gates)
